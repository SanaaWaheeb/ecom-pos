<section class="card-sec padding-bottom"
    ...
    <img src="<?php echo e(asset('themes/' .$currentTheme . '/assets/images/d4.png')); ?> " class="d-left" style="top: 25%;">
    <img src="<?php echo e(asset('themes/' .$currentTheme . '/assets/images/right.png')); ?>" class="d-right" style="bottom: 0">
    <img src="<?php echo e(asset('themes/' .$currentTheme . '/assets/images/leaf2.png')); ?>" class="desk-only" id="card-leaf2"
        alt="leaf2">
    <div class=" container">
        <div class="row">
            <div class="col-lg-6 col-12 img-main-box">
                <div class="img-box">
                    <img src="<?php echo e(get_file($section->best_product->section->image->image ?? '', $currentTheme)); ?>" class="card-img"
                        id="<?php echo e(($section->best_product->section->image->slug ?? '').'_preview'); ?>" alt="img1">
                    <div class="inner-text">
                        <div class="common-heading">
                            <span class="sub-heading"
                                id="<?php echo e(($section->best_product->section->sub_title->slug ?? '')); ?>_preview">
                                <?php echo $section->best_product->section->sub_title->text ?? ""; ?></span>
                            <h3 id="<?php echo e(($section->best_product->section->title->slug ?? '')); ?>_preview">
                                <a href="<?php echo e(route('page.product-list', $slug)); ?>"><?php echo $section->best_product->section->title->text ?? ""; ?></b></a>
                            </h3>
                            <p id="<?php echo e(($section->best_product->section->description->slug ?? '')); ?>_preview"><?php echo $section->best_product->section->description->text ?? ""; ?></p>
                            <div class=" d-flex justify-content-center align-items-center">
                                <a href="<?php echo e(route('page.product-list', $slug)); ?>" class="common-btn"
                                    id="<?php echo e(($section->best_product->section->button->slug ?? '')); ?>_preview"><?php echo $section->best_product->section->button->text; ?></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="inner-card">
                        <div class="wishlist-wrapper">
                            <a href="JavaScript:void(0)"
                                ...
                                product_id="<?php echo e($data->id); ?>" in_wishlist="<?php echo e($data->in_whishlist ? 'remove' : 'add'); ?>">
...
<?php /**PATH C:\xampp\htdocs\ecommerce-pos\themes\minimarket\views/front_end/sections/homepage/best_product_section.blade.php ENDPATH**/ ?>