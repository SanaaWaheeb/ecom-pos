            ...
            <div class="mini-cart-item">
                ...
                <div class="mini-cart-details">
                    ...
                    <div class="qty-spinner">
                        ...
                        <input type="text" class="quantity 45_quatity" data-cke-saved-name="quantity" name="quantity" value="<?php echo e($item->qty); ?>" min="01" id="cart_list_sidebar_quantity<?php echo e($item->qty); ?>" data-id="463">
        ...
        <?php if(!empty($response->data->cart_total_product)): ?>
            ...
            <div class="mini-cart-footer-total-row d-flex align-items-center justify-content-between">
                ...
                <div class="mini-total-price">
                    <?php echo e(currency_format_with_sym(($final ?? 0) , $store->id, $currentTheme) ??  SetNumberFormat($final)); ?>
...
<?php /**PATH C:\xampp\htdocs\ecommerce-pos\themes\minimarket\views/front_end/sections/pages/cart-list-sidebar.blade.php ENDPATH**/ ?>