<section class="best-seller-sec padding-bottom padding-top"
    ...
    <img src="<?php echo e(asset('themes/' .$currentTheme . '/assets/images/d1.png')); ?>" class="d-right" style="top: 0;">
    <img src="<?php echo e(asset('themes/' .$currentTheme . '/assets/images/d2.png')); ?>" class="d-left" style="bottom: 0;">
    <img src="<?php echo e(asset('themes/' .$currentTheme . '/assets/images/left.png')); ?>" class="d-left" style="top: 0;">
    <div class=" container">
        <div class="seller-heading text-center">
            <h2 id="<?php echo e(($section->bestseller_slider->section->title->slug ?? '')); ?>_preview">
                <a href="<?php echo e(route('page.product-list', $slug)); ?>"><?php echo $section->bestseller_slider->section->title->text
                    ?? ""; ?></b></a>
            </h2>
        </div>
        <div class="best-seller-slider flex-slider">
            <?php $__currentLoopData = $bestSeller; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="inner-card">
                            <div class="wishlist-wrapper">
                                <a href="JavaScript:void(0)"
                                    ...
                                    tabindex="0" product_id="<?php echo e($data->id); ?>"
                                    in_wishlist="<?php echo e($data->in_whishlist ? 'remove' : 'add'); ?>"><?php echo e(__('Add to wishlist')); ?>

                                    <span class="wish-ic">
                                        <i
                                            class="<?php echo e($data->in_whishlist ? 'fa fa-heart' : 'ti ti-heart'); ?>"></i>
                                    </span>
                                </a>
...
<?php /**PATH C:\xampp\htdocs\ecommerce-pos\themes\minimarket\views/front_end/sections/homepage/bestseller_slider_section.blade.php ENDPATH**/ ?>