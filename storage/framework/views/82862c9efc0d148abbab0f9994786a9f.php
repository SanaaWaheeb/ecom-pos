                            ...
                            <div class="row d-flex">
                                <?php if(\Auth::user()->type != 'super admin'): ?>
                                    ...
                                    <?php if($plan->id != \Auth::user()->plan_id): ?>
                                        <?php if($plan->price > 0): ?>
                                            <div class="<?php echo e($plan->id == 1 ? 'col-12' : 'col-12'); ?>">
                                                <div class="row">
                                                    <div class="col-9">
                                                    <a href="<?php echo e(route('stripe', \Illuminate\Support\Facades\Crypt::encrypt($plan->id))); ?>"
                                                        class="btn w-100 btn-badge btn-primary"><?php echo e(__('Subscribe')); ?>
                                                        ...
                                                        <?php if(\Auth::user()->type != 'super admin' && \Auth::user()->plan_id != $plan->id): ?>
                                                            <?php if($plan->price > 0 && \Auth::user()->trial_plan == 0 && \Auth::user()->plan_id != $plan->id && $plan->trial == 1): ?>
                                                                <a href="<?php echo e(route('plan.trial', \Illuminate\Support\Facades\Crypt::encrypt($plan->id))); ?>"
                                                                    class="btn btn-lg btn-primary btn-badge btn-icon m-1 w-100"><?php echo e(__('Start Free Trial')); ?></a>
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce-pos\resources\views/plans/index.blade.php ENDPATH**/ ?>