                                ...
                                <div class="form-wrapper">
                                    ...
                                    <div class="form-container">
                                        <div class="d-flex acc-back-btn-wrp align-items-center justify-content-end">
                                            <button class="btn back-btn-acc" type="submit">
                                            ...
                                            <input type="hidden" name="type" value="{{auth('customers')->user()->type ?? 'customer'}}">
                                                <div class="form-group">
                                                    ...
                                                    <input name="old_password" type="password" class="form-control"
                                                        placeholder="**********" required=""  value="{{ old('old_password') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="new_password" type="password" class="form-control"
                                                        placeholder="**********" required="" value="{{ old('new_password') }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="new_password_confirmation" type="password"
                                                        class="form-control" placeholder="***********" required="" value="{{ old('new_password_confirmation') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
